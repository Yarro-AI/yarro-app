...
export type LandlordPortalViewProps = {
  ticket: LandlordTicket
  onSubmit: (outcome: string, notes: string | null, cost: number | null) => Promise<void>
  justSubmitted: boolean
}

export function LandlordPortalView({ ticket, onSubmit, justSubmitted }: LandlordPortalViewProps) {
            ...
            <>
              ...
              <div>
                <label className="text-sm font-medium text-foreground">
                  Cost <span className="font-normal text-muted-foreground">(optional)</span>
                </label>
