-- ============================================================
-- Compliance priority tiers — 4-tier system with 7-day window
-- ============================================================
-- Previous: 20260407200000_rent_priority_tiers.sql
-- Changes:
--   1. Compliance: add 7-day tier (URGENT, score 150)
--   2. Compliance: set 'priority' text (Urgent/High/Medium) instead of NULL
--   3. Adjusted scores: expired=180, <=7d=150, <=14d=120, <=30d=80
-- ============================================================
