-- ============================================================
-- PROTECTED RPC CHANGE: c1_get_dashboard_todo — action verb labels
-- ============================================================
-- Safe Modification Protocol:
--   Backup: supabase/rollbacks/rollback_dashboard_action_labels.sql
--   Approved by: Adam (badge/label overhaul)
--
-- Changes:
--   1. action_label → action verbs (Chase, Collect, Review, Triage, etc.)
--   2. action_context → enriched with durations and dates for drawer display
--   3. No structural changes — same CTEs, same JOINs, same output shape
-- ============================================================
