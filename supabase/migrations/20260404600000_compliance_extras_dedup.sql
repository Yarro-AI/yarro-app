-- ============================================================
-- Dashboard extras compliance dedup — exclude compliance certs
-- that already have an open renewal ticket (YAR-158)
-- ============================================================
-- Matches the dedup pattern in compliance_get_todos:
-- LEFT JOIN c1_tickets + AND t.id IS NULL
-- Rent items already had this check; compliance items did not.
