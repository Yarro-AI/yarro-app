-- Add auto_approve_limit and label to c1_ticket_detail
-- Needed by drawer: auto_approve_limit for quote approval display,
-- label from conversation log for title fallback.
