-- Expose sla_total_hours in both dashboard and ticket-detail RPCs.
-- Computed from sla_due_at - waiting_since (set atomically by trigger).
-- No new column — pure derived field for frontend SLA ring display.
