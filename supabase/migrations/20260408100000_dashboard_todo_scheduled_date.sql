-- ============================================================
-- PROTECTED RPC CHANGE: c1_get_dashboard_todo — add scheduled_date
-- ============================================================
-- Safe Modification Protocol:
--   Backup: supabase/rollbacks/rollback_dashboard_todo_scheduled_date.sql
--   Approved by: Adam (YAR-221 dashboard scheduled section)
--
-- Changes:
--   1. Add t.scheduled_date to scored CTE SELECT
--   2. Add 'scheduled_date' key to jsonb_build_object output (19th key)
--
-- Signature unchanged. Output adds one nullable key.
-- ============================================================
