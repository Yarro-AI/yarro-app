-- ============================================================
-- Rent priority tiers — 4-tier system (YAR-226)
-- ============================================================
-- Previous: 20260404610000_compliance_extras_dedup.sql
-- Changes:
--   1. Rent priority: 4-tier (Normal/Medium/High/Urgent) based on days_overdue
--   2. sla_breached threshold: >= 14 days (was > 7)
--   3. Priority scores: fixed tiers (40/60/90/130) instead of dynamic LEAST()
-- ============================================================
