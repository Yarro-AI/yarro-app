-- ============================================================
-- PROTECTED RPC CHANGE: c1_get_dashboard_todo — expose sla_due_at
-- ============================================================
-- Safe Modification Protocol:
--   Backup: supabase/rollbacks/rollback_dashboard_todo_sla_due_at.sql
--   Previous: 20260405600000_dashboard_todo_perf.sql
--   Approved by: Adam (YAR-226 SLA badges on dashboard)
--
-- Changes:
--   1. Add 'sla_due_at' key to JSON output (s.sla_due_at already in scored CTE)
--
-- No signature changes. 19 JSONB keys (was 18). Same ORDER BY.
-- ============================================================
